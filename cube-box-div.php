...
<body>
    ...
    <div class="splash" style="padding-bottom:250px">
<!-- navbar-dark bg-dark -->
...
#bars
{
    ...
    display:none;
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul style="list-style-type: none;" class="navbar-nav mr-auto">
        ...
        <div class="col-md-6" style="margin-top:50px;">
            <div class="container">
                ...
                <h1 style="color: #dce3e8; font-family: typodermic; letter-spacing: 5px;">The platform for medical
                    AI</h1>
            </div>
        </div>
        <div class="col-md-6">
